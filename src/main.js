...
const USE_CASES = [
  ...
  { group: 'Threads — in chat (Threads)', items: [
    ...
    { id: 'th-qa',      label: 'Composer · thread toggle ON (#22273)', screen: 'chat', params: 'version=revamp&theme=dark&qa=thread' },
    { id: 'th-hover',   label: 'Hover bar · thread icon (#22274)',    screen: 'chat', params: 'version=revamp&theme=dark&actions=1' },
